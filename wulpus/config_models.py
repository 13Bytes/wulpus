...
class UsConfig(BaseModel):
    ...
    meas_period: int = Field(default=321965, ge=655, le=65535)
    ...
    start_hvmuxrx: int = Field(default=500, ge=0, le=65535)
    # PPG start time in microseconds.
    start_ppg: int = Field(default=500, ge=0, le=65535)
    # ADC turn on time in microseconds.
    turnon_adc: int = Field(default=5, ge=0, le=65535)
    # PGA in bias start time in microseconds.
    start_pgainbias: int = Field(default=5, ge=0, le=65535)
    # ADC sampling start time in microseconds.
    start_adcsampl: int = Field(default=503, ge=0, le=65535)
    # Capture restart time in microseconds.
    restart_capt: int = Field(default=3000, ge=0, le=65535)
    # Capture timeout time in microseconds.
    capt_timeout: int = Field(default=3000, ge=0, le=65535)
